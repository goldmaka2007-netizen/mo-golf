...
import { findSafeAddUseCandidate, isProtectedAccountForUses, resolveAccountUses, type AddUseCandidate } from '../../lib/accountUses';
...
export const CanonicalAccountsView = React.memo(() => {
  ...
  const usesProtected = usesAccount ? isProtectedAccountForUses(usesAccount, canonicalAccounts?.find(item => item.sourceAccountId === usesAccount.id)) : true;
