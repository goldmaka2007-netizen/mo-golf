...
const StatsCard = React.memo(({ value, label, color, icon }: StatsCardProps) => (
  <div className="bg-[#0e1018] border border-[#c9a84c22] rounded-2xl p-6 text-center shadow-xl relative overflow-hidden group hover:border-[#c9a84c55] transition-all">
    ...
    <div className={cn("text-4xl md:text-5xl font-bold mb-2 font-mono", color)}>{value}</div>
    <div className="text-sm text-[#5a5548] font-bold uppercase tracking-widest">{label}</div>
  </div>
));
